    ...
    <div
        ...
        <div
            ...
            <div class="flex items-center gap-4 flex-1">
                ...
                <div>
                    <h2 class="text-lg font-bold text-gray-800">Manajemen Jadwal Mengajar</h2>
        ...
        <div class="p-4 sm:p-5">
            ...
            <div class="bg-slate-50 p-4 sm:p-5 rounded-xl border border-gray-100 mb-6 shadow-inner">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3 pt-4 border-t border-gray-200/60">
                    ...
                    <div>
                        <select wire:model.live="filter_ta"
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2 mt-0.5">
                                        <span
                                            ...
                                            {{ $guru->jadwals->count() }} Jadwal Mengajar
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="overflow-x-auto rounded-lg border border-gray-200 shadow-sm  bg-white">
                                <table class="w-full text-left min-w-[550px]">
                                    ...
                                    <tbody class="divide-y divide-gray-100">
                                        @foreach ($guru->jadwals as $idx => $jadwal)
                                            <tr class="hover:bg-orange-50/40 transition-colors"
                                                ...
                                                <td class="px-4 py-3 whitespace-nowrap">
                                                    <span class="text-xs font-medium text-slate-600">
                                                        {{ $jadwal->tahunAjaran->nama_ta ?? '-' }}
                                                        ({{ ucfirst($jadwal->tahunAjaran->semester ?? '') }})
                                                    </span>
                                                </td>
                                                ...
                                                <td class="px-4 py-3 text-center whitespace-nowrap">
                                                    ...
                                                    @endphp
                                                    <span
                                                        class="px-2.5 py-1 rounded-md text-[10px] sm:text-[11px] font-bold uppercase border {{ $statusColor }}">
                                                        {{ $jadwal->status ?? '-' }}
                                                    </span>
                                                </td>
